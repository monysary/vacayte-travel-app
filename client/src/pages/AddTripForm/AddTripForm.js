...
function AddTripForm() {
  ...
  function ActivityChoices({
    ...
    const handleClick = () => {
      if (!selected) {
        setFormState({
          ...formState,
          activities: [...formState.activities, { name: activityName }],
        });
        setActivity(
        ...
        setFormState({
          ...formState,
          activities: formState.activities.filter(
  ...
  return (
    <ThemeProvider theme={theme}>
      <Box
        sx={{
          // padding messes up the shrinking
          //   paddingX: "300px",
          ...
          >
            ...
            <Box>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  <Typography fontFamily={font.primary}>
                    Where are you going?
                  </Typography>
                  <TextField
                    required
